...
target_status_married = ['2011_7. 혼인상태', '2013_5.혼인상태', '2015_분류코드_혼인상태코드', '2017_분류코드_혼인상태코드', '2019_분류코드_혼인상태코드', '2021_분류코드_혼인상태코드', '2023_분류코드_혼인상태코드'] # 27. 혼인상태
# 28. 거처 종류 - 제거
# 29. 점유 형태 - 제거
...
## 51. 국내숙박여행 유무 ~ 54. 전반적 일자리 만족도
# 51. 국내숙박여행 유무 - 생략
# 52. 국내당일치기 유무 - 생략
target_satisfy_wage= ['2011_72.임금', '2013_68.근로여건만족도(임금)', '2015_근로여건만족도_급여코드', '2017_근로여건만족도_급여코드', '2019_근로여건만족도_급여코드', '2021_근로여건만족도_급여코드', '2023_근로여건만족도_급여코드'] # 53. 임금 만족도
target_satisfy_overall_working= ['2011_72-1.현재의 일자리 만족도', '2013_68-1.일자리만족도', '2015_전반적일자리만족도코드', '2017_근로여건만족도_전반적일자리코드', '2019_근로여건만족도_전반적일자리코드', '2021_근로여건만족도_전반적일자리코드', '2023_근로여건만족도_전반적일자리코드'] # 54. 전반적 일자리 만족도
...
# 51
# 52
refined_data['satisfy_wage'] = data[target_satisfy_wage].apply(lambda x: ','.join(x.dropna().astype(str)), axis=1)
refined_data['satisfy_overall_working'] = data[target_satisfy_overall_working].apply(lambda x: ','.join(x.dropna().astype(str)), axis=1)
